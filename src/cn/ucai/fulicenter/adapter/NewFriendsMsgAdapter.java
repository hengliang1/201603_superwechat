...
public class NewFriendsMsgAdapter extends ArrayAdapter<InviteMessage> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = View.inflate(context, cn.ucai.fulicenter.R.layout.row_invite_msg, null);
			holder.avator = (NetworkImageView) convertView.findViewById(cn.ucai.fulicenter.R.id.avatar);
			holder.reason = (TextView) convertView.findViewById(cn.ucai.fulicenter.R.id.message);
			holder.name = (TextView) convertView.findViewById(cn.ucai.fulicenter.R.id.name);
			holder.status = (Button) convertView.findViewById(cn.ucai.fulicenter.R.id.user_state);
			holder.groupContainer = (LinearLayout) convertView.findViewById(cn.ucai.fulicenter.R.id.ll_group);
			holder.groupname = (TextView) convertView.findViewById(cn.ucai.fulicenter.R.id.tv_groupName);
		...
		String str1 = context.getResources().getString(cn.ucai.fulicenter.R.string.Has_agreed_to_your_friend_request);
		String str2 = context.getResources().getString(cn.ucai.fulicenter.R.string.agree);

		String str3 = context.getResources().getString(cn.ucai.fulicenter.R.string.Request_to_add_you_as_a_friend);
		String str4 = context.getResources().getString(cn.ucai.fulicenter.R.string.Apply_to_the_group_of);
		String str5 = context.getResources().getString(cn.ucai.fulicenter.R.string.Has_agreed_to);
		String str6 = context.getResources().getString(cn.ucai.fulicenter.R.string.Has_refused_to);
	...
	private void acceptInvitation(final Button button, final InviteMessage msg) {
		...
		String str1 = context.getResources().getString(cn.ucai.fulicenter.R.string.Are_agree_with);
		final String str2 = context.getResources().getString(cn.ucai.fulicenter.R.string.Has_agreed_to);
		final String str3 = context.getResources().getString(cn.ucai.fulicenter.R.string.Agree_with_failure);
		pd.setMessage(str1);
