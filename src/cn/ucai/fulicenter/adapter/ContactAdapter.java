	...
	public View getView(int position, View convertView, ViewGroup parent) {
	    ViewHolder holder;
 		if(convertView == null){
			...
			holder.unreadMsgView = (TextView) convertView.findViewById(cn.ucai.fulicenter.R.id.unread_msg_number);
			holder.nameTextview = (TextView) convertView.findViewById(cn.ucai.fulicenter.R.id.name);
			holder.tvHeader = (TextView) convertView.findViewById(cn.ucai.fulicenter.R.id.header);
...
//			    holder.unreadMsgView.setText(user.getUnreadMsgCount()+"");
			...
			holder.nameTextview.setText(user.getMUserNick());
		    holder.avatar.setDefaultImageResId(cn.ucai.fulicenter.R.drawable.groups_icon);
			...
			//Robot item
			holder.nameTextview.setText(user.getMUserNick());
			holder.avatar.setImageResource(cn.ucai.fulicenter.R.drawable.groups_icon);
		}else{
	...
	public Object[] getSections() {
		...
		list.add(mcontext.getString(cn.ucai.fulicenter.R.string.search_header));
