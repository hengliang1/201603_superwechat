...
public class SettingsActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(savedInstanceState != null && savedInstanceState.getBoolean("isConflict", false))
            return;
		rl_switch_notification = (RelativeLayout) findViewById(cn.ucai.fulicenter.R.id.rl_switch_notification);
		rl_switch_sound = (RelativeLayout) findViewById(cn.ucai.fulicenter.R.id.rl_switch_sound);
		rl_switch_vibrate = (RelativeLayout) findViewById(cn.ucai.fulicenter.R.id.rl_switch_vibrate);
		rl_switch_speaker = (RelativeLayout) findViewById(cn.ucai.fulicenter.R.id.rl_switch_speaker);
		rl_switch_chatroom_leave = (RelativeLayout) findViewById(cn.ucai.fulicenter.R.id.rl_switch_chatroom_owner_leave);

		iv_switch_open_notification = (ImageView) findViewById(cn.ucai.fulicenter.R.id.iv_switch_open_notification);
		iv_switch_close_notification = (ImageView) findViewById(cn.ucai.fulicenter.R.id.iv_switch_close_notification);
		iv_switch_open_sound = (ImageView) findViewById(cn.ucai.fulicenter.R.id.iv_switch_open_sound);
		iv_switch_close_sound = (ImageView) findViewById(cn.ucai.fulicenter.R.id.iv_switch_close_sound);
		iv_switch_open_vibrate = (ImageView) findViewById(cn.ucai.fulicenter.R.id.iv_switch_open_vibrate);
		iv_switch_close_vibrate = (ImageView) findViewById(cn.ucai.fulicenter.R.id.iv_switch_close_vibrate);
		iv_switch_open_speaker = (ImageView) findViewById(cn.ucai.fulicenter.R.id.iv_switch_open_speaker);
		iv_switch_close_speaker = (ImageView) findViewById(cn.ucai.fulicenter.R.id.iv_switch_close_speaker);
		
		iv_switch_room_owner_leave_allow = (ImageView) findViewById(cn.ucai.fulicenter.R.id.iv_switch_chatroom_owner_leave_allow);
		iv_switch_room_owner_leave_disallow = (ImageView) findViewById(cn.ucai.fulicenter.R.id.iv_switch_chatroom_owner_leave_not_allow);
		
		
		logoutBtn = (Button) findViewById(cn.ucai.fulicenter.R.id.btn_logout);
		...
		textview1 = (TextView) findViewById(cn.ucai.fulicenter.R.id.textview1);
		textview2 = (TextView) findViewById(cn.ucai.fulicenter.R.id.textview2);
		
		blacklistContainer = (LinearLayout) findViewById(cn.ucai.fulicenter.R.id.ll_black_list);
		userProfileContainer = (LinearLayout) findViewById(cn.ucai.fulicenter.R.id.ll_user_profile);
		llDiagnose=(LinearLayout) findViewById(cn.ucai.fulicenter.R.id.ll_diagnose);
		pushNick=(LinearLayout)  findViewById(cn.ucai.fulicenter.R.id.ll_set_push_nick);
