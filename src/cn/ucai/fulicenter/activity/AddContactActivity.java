...
public class AddContactActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtvShowNothing = (TextView) findViewById(R.id.tv_show_nothing);
    }
    ...
    public void searchContact(View v) {
        ...
        try {
            ...
            executeRequest(new GsonRequest<User>(path,User.class,
                    responseSearchContactListener(), errorListener()));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

    private Response.Listener<User> responseSearchContactListener() {
        return new Response.Listener<User>() {
            ...
            public void onResponse(User user) {
                if (user != null) {
                    ...
                    mtvShowNothing.setVisibility(View.GONE);
                } else {
                    searchedUserLayout.setVisibility(View.GONE);
                    mtvShowNothing.setVisibility(View.VISIBLE);
                }
            }
        };
    }
