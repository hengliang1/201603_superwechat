...
public class PickContactNoCheckboxActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.fulicenter.R.layout.activity_pick_contact_no_checkbox);
		listView = (ListView) findViewById(cn.ucai.fulicenter.R.id.list);
		sidebar = (Sidebar) findViewById(cn.ucai.fulicenter.R.id.sidebar);
		sidebar.setListView(listView);
		contactList = new ArrayList<Contact>();
		// 获取设置contactlist
		getContactList();
		// 设置adapter
		contactAdapter = new ContactAdapter(this, cn.ucai.fulicenter.R.layout.row_contact, contactList);
