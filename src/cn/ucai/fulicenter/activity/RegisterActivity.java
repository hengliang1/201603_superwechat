		...
		findViewById(R.id.btnRegister).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (TextUtils.isEmpty(username)) {
					...
					passwordEditText.setError(getResources().getString(cn.ucai.fulicenter.R.string.Password_cannot_be_empty));
					return;
				} else if (TextUtils.isEmpty(confirm_pwd)) {
					confirmPwdEditText.requestFocus();
					confirmPwdEditText.setError(getResources().getString(cn.ucai.fulicenter.R.string.Confirm_password_cannot_be_empty));
					return;
				} else if (!pwd.equals(confirm_pwd)) {
					confirmPwdEditText.requestFocus();
					confirmPwdEditText.setError(getResources().getString(cn.ucai.fulicenter.R.string.Two_input_password));
					return;
				}
