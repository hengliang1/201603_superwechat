...
import cn.ucai.superwechat.activity.ContextMenu;
...
public class MessageAdapter extends BaseAdapter{
	...
	private View createViewByMessage(EMMessage message, int position) {
		...
		case LOCATION:
			return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(cn.ucai.superwechat.R.layout.row_received_location, null) : inflater.inflate(
					cn.ucai.superwechat.R.layout.row_sent_location, null);
		case IMAGE:
			return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(cn.ucai.superwechat.R.layout.row_received_picture, null) : inflater.inflate(
					cn.ucai.superwechat.R.layout.row_sent_picture, null);

		case VOICE:
			return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(cn.ucai.superwechat.R.layout.row_received_voice, null) : inflater.inflate(
					cn.ucai.superwechat.R.layout.row_sent_voice, null);
		case VIDEO:
			return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(cn.ucai.superwechat.R.layout.row_received_video, null) : inflater.inflate(
					cn.ucai.superwechat.R.layout.row_sent_video, null);
		case FILE:
			return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(cn.ucai.superwechat.R.layout.row_received_file, null) : inflater.inflate(
					cn.ucai.superwechat.R.layout.row_sent_file, null);
		default:
			// 语音通话
			if (message.getBooleanAttribute(Constant.MESSAGE_ATTR_IS_VOICE_CALL, false))
				return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(cn.ucai.superwechat.R.layout.row_received_voice_call, null) : inflater
						.inflate(cn.ucai.superwechat.R.layout.row_sent_voice_call, null);
			// 视频通话
			else if (message.getBooleanAttribute(Constant.MESSAGE_ATTR_IS_VIDEO_CALL, false))
				return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(cn.ucai.superwechat.R.layout.row_received_video_call,
						null) : inflater.inflate(cn.ucai.superwechat.R.layout.row_sent_video_call, null);
			// 含有菜单的消息	
			else if (((DemoHXSDKHelper)HXSDKHelper.getInstance()).isRobotMenuMessage(message))
				return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(cn.ucai.superwechat.R.layout.row_received_menu, null)
						: inflater.inflate(cn.ucai.superwechat.R.layout.row_sent_message, null);
			else
				return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(cn.ucai.superwechat.R.layout.row_received_message,
						null) : inflater.inflate(cn.ucai.superwechat.R.layout.row_sent_message, null);
		}
	}
		...
		if (convertView == null) {
			...
			if (message.getType() == EMMessage.Type.IMAGE) {
				...
				try {
					...
					holder.staus_iv = (ImageView) convertView.findViewById(cn.ucai.superwechat.R.id.msg_status);
					holder.tv_usernick = (TextView) convertView.findViewById(cn.ucai.superwechat.R.id.tv_userid);
					holder.iv_read_status = (ImageView) convertView.findViewById(cn.ucai.superwechat.R.id.iv_unread_voice);
				} catch (Exception e) {
				}
				...
				try {
					...
					holder.timeLength = (TextView) convertView.findViewById(cn.ucai.superwechat.R.id.chatting_length_iv);
					holder.playBtn = (ImageView) convertView.findViewById(cn.ucai.superwechat.R.id.chatting_status_btn);
					holder.container_status_btn = (LinearLayout) convertView.findViewById(cn.ucai.superwechat.R.id.container_status_btn);
					holder.tv_usernick = (TextView) convertView.findViewById(cn.ucai.superwechat.R.id.tv_userid);
				...
				try {
					...
					holder.pb = (ProgressBar) convertView.findViewById(cn.ucai.superwechat.R.id.pb_sending);
					holder.staus_iv = (ImageView) convertView.findViewById(cn.ucai.superwechat.R.id.msg_status);
					holder.tv_file_download_state = (TextView) convertView.findViewById(cn.ucai.superwechat.R.id.tv_file_state);
					holder.ll_container = (LinearLayout) convertView.findViewById(cn.ucai.superwechat.R.id.ll_file_container);
					// 这里是进度值
					holder.tv = (TextView) convertView.findViewById(cn.ucai.superwechat.R.id.percentage);
				} catch (Exception e) {
				}
	...
	private void handleImageMessage(final EMMessage message, final ViewHolder holder, final int position, View convertView) {
		...
		if (message.direct == EMMessage.Direct.RECEIVE) {
			...
			if (message.status == EMMessage.Status.INPROGRESS) {
				// "!!!! back receive";
				holder.iv.setImageResource(cn.ucai.superwechat.R.drawable.default_image);
	...
	private void handleVideoMessage(final EMMessage message, final ViewHolder holder, final int position, View convertView) {
		...
		holder.playBtn.setImageResource(cn.ucai.superwechat.R.drawable.video_download_btn_nor);
